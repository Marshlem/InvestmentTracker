        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssetCategories_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueChangeCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "EUR"),
                    DividendCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "EUR"),
                    UserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueChange = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    CurrentValue = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
                    Dividend = table.Column<decimal>(type: "numeric(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetCategories_UserId_Name",
