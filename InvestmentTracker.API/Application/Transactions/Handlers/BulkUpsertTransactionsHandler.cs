...
public sealed class BulkUpsertTransactionsHandler
    : IRequestHandler<BulkUpsertTransactionsCommand, BulkUpsertResult>
{
    ...
    public async Task<BulkUpsertResult> Handle(
        BulkUpsertTransactionsCommand request,
        CancellationToken ct)
    {
        ...
        await _txService.BulkUpsertAsync(
            request.UserId,
            request.Date,
            entities
        );
