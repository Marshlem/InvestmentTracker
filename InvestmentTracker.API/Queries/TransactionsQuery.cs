...
public class TransactionsQuery
{
    ...
    public TransactionsQuery(ApplicationDbContext db) => _db = db;

    public async Task<List<TransactionEditDto>> ExecuteAsync(DateTime date)
    {
        ...
        return await _db.Assets
            ...
            .Select(x => new TransactionEditDto
            {
                ...
                Transaction = x.Tx == null ? null : new TransactionEditRowDto
                {
